...
const routes: Routes = [
    {
        ...
        children: [
          ...
          //    { path: 'heroes', loadChildren: './component/heroes/heroes.module#HeroModule' },
            //    { path: 'herodetail', loadChildren: './component/herodetail/herodetail.module#HeroDetailsModule' },
              //  { path: 'messages', loadChildren: './component/messages/messages.module#HeroModule' },
           //  { path: 'test', loadChildren: './component/test/test.module#TestModule' },
            { path: 'training', loadChildren: './component/training/training.module#TrainingModule' }
